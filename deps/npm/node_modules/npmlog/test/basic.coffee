...
# should be the same.
logInfoEventsExpect = logPrefixEventsExpect
logEventsExpect = [
  {
    id: 0
    level: "silly"
...
tap.test "basic", (t) ->
  ...
  log.level = "silly"
  log.silly "silly prefix", "x = %j",
    foo:
      bar: "baz"

  log.verbose "verbose prefix", "x = %j",
    foo:
      bar: "baz"

  log.info "info prefix", "x = %j",
    foo:
      bar: "baz"

  log.http "http prefix", "x = %j",
    foo:
      bar: "baz"

  log.warn "warn prefix", "x = %j",
    foo:
      bar: "baz"

  log.error "error prefix", "x = %j",
    foo:
      bar: "baz"

  log.silent "silent prefix", "x = %j",
    foo:
      bar: "baz"
