...
test "npa-basic", (t) ->
  ...
  Object.keys(tests).forEach (arg) ->
    rps arg, path.resolve(__dirname, ".."), (err, res) ->
  ...
  rps "this is not a \u0000 valid package name or url", path.resolve(__dirname, ".."), (err) ->
    t.ok err, "error"
    return

  rps "gopher://yea right", path.resolve(__dirname, ".."), (err) ->
