...
keys = [].concat(Object.keys(apacheTypes.types)).concat(Object.keys(nodeTypes.types))
keys.sort()
i = 1

while i < keys.length
  console.warn "Warning: " + "node.types defines " + keys[i] + "->" + nodeTypes.types[keys[i]] + ", mime.types defines " + keys[i] + "->" + apacheTypes.types[keys[i]]  if keys[i] is keys[i - 1]
  i++
console.log "\nOK"
