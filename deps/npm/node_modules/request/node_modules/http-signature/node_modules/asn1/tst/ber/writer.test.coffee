...
test "write buffer", (t) ->
  ...
  while i < ber.length and j < buf.length
...
test "resize internal buffer", (t) ->
  writer = new BerWriter(size: 2)
  writer.writeString "hello world"
  ber = writer.buffer
  t.ok ber
  t.equal ber.length, 13, "wrong length"
...
test "Write OID", (t) ->
  ...
  console.log require("util").inspect(new Buffer([
    0x06
    0x09
    0x2a
    0x86
