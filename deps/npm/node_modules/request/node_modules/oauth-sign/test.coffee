hmacsign = require("./index").hmacsign
...
# example in rfc5849
params = qs.parse("b5=%3D%253D&a3=a&c%40=&a2=r%20b" + "&" + "c2&a3=2+q")
...
rfc5849sign = hmacsign("POST", "http://example.com/request", params, "j49sk3j29djd", "dh893hdasih9")
