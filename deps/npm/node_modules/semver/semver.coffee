...
debug = undefined
if typeof process is "object" and process.env and process.env.NODE_DEBUG and /\bsemver\b/i.test(process.env.NODE_DEBUG)
  debug = ->
...
SemVer::compare = (other) ->
  debug "SemVer.compare", @version, @loose, other
...
Comparator::test = (version) ->
  debug "Comparator.test", version, @loose
