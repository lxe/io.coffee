...
#            == x + x * x / 2 + x * x * x / 6 + ...
expm1 = (x) ->
  x * (1 + x * (1 / 2 + x * (1 / 6 + x * (1 / 24 + x * (1 / 120 + x * (1 / 720 + x * (1 / 5040 + x * (1 / 40320 + x * (1 / 362880 + x * (1 / 3628800))))))))))
assertTrue isNaN(Math.expm1(NaN))
assertTrue isNaN(Math.expm1(->
))
assertTrue isNaN(Math.expm1(toString: ->
  NaN
))
assertTrue isNaN(Math.expm1(valueOf: ->
  "abc"
))
